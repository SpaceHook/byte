...
<div class="banners">
    ...
    <span class="banners__title">Картинка (Деск.)</span>
    <span class="banners__title">Картинка (моб.)</span>
    ...
    <img src="{{ asset('storage/' . $banner->translation('ua')?->image) }}" alt="Банер" class="banners__image">
    <img src="{{ asset('storage/' . $banner->translation('ua')?->image_mob) }}" alt="Банер моб." class="banners__image">
