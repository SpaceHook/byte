        ...
        @if(isset($fields) && in_array('name', $fields))
            <div class="form__fields-field">
                ...
                <div class="form__fields-field-inputs">
                    <input type="text" placeholder="{{__('form.name')}}"  class="form__fields-field-input default-input">
                    <input type="text" placeholder="{{__('form.surname')}}"  class="form__fields-field-input default-input">
                </div>
            </div>
        @endif
